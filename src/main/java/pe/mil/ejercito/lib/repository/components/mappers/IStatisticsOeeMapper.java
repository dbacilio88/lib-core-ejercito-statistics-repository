...
public interface IStatisticsOeeMapper {
    ...
    @Mapping(target = "stSetPersonal", source = "septPersonal")
    ...
    @Mapping(target = "stTotalPerson", source = "totalPersonal")
    ...
    @Mapping(target = "septPersonal", source = "stSetPersonal")
    ...
    @Mapping(target = "totalPersonal", source = "stTotalPerson")
