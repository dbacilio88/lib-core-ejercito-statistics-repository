...
public class StatisticsCoadneDomainService extends ReactorServiceBase implements IStatisticsCoadneDomainService {
    ...
    @Override
    public Mono<StatisticsCoadneDto> getByIdEntity(Long id) {
        ...
        final Optional<EpStatisticsCoadneEntity> persistenceEntity = this.repository.findById(id);

        return getStatisticsCoadneDto(
            persistenceEntity,
    ...
    @Override
    public Mono<StatisticsCoadneDto> getByUuIdEntity(String uuId) {
        ...
        final Optional<EpStatisticsCoadneEntity> persistenceEntity = this.repository.findByUuId(uuId);
    ...
    @Override
    public Mono<StatisticsCoadneDto> updateEntity(StatisticsCoadneDto dto) {
    ...
    private Mono<StatisticsCoadneDto> doOnUpdate(StatisticsCoadneDto dto) {
        return Mono.just(dto)
            .flatMap(request -> {
                ...
                final Optional<EpStatisticsCoadneEntity> statisticsAeEntity = this.repository.findByUuId(request.getUuId());
    ...
    @Override
    public Mono<StatisticsCoadneDto> deleteByUuIdEntity(String uuId) {
        if (Boolean.TRUE.equals(CommonRequestHelper.isInvalidUuId(uuId))) {
    ...
    private Mono<StatisticsCoadneDto> getStatisticsCoadneDto(Optional<EpStatisticsCoadneEntity> brEntity, String successMessage, String messageExist) {
    ...
    @Override
    public Mono<List<StatisticsCoadneDto>> getAllEntities(String document, String limit, String page, PageableDto pageable) {
        Pageable paging = PageRequest.of(Integer.parseInt(page) - 1, Integer.parseInt(limit));
        Page<EpStatisticsCoadneEntity> entityPage = this.repository.findAll(document, paging);
        List<StatisticsCoadneDto> brigades = this.mapper.mapperToList(entityPage.getContent());
