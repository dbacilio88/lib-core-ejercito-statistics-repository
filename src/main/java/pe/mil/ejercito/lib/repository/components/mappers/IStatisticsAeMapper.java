...
public interface IStatisticsAeMapper {
    ...
    @Mapping(target = "staDocument.uuId", source = "document")
    ...
    @Mapping(target = "staMaintenance", source = "maintenance")
    @Mapping(target = "staTypeHelicopter", source = "typeHelicopter")
    @Mapping(target = "staAirplaneRegistration", source = "airplaneRegistration")
    @Mapping(target = "staHrsMaintenance", source = "hrsMaintenance")
    @Mapping(target = "staHrsAssigned", source = "hrsAssigned")
    @Mapping(target = "staHrsFlown", source = "hrsFlown")
    ...
    @Mapping(target = "id", source = "id")
    @Mapping(target = "uuId", source = "uuId")
    @Mapping(target = "document", source = "staDocument.uuId")
    ...
    @Mapping(target = "maintenance", source = "staHrsMaintenance")
    @Mapping(target = "typeHelicopter", source = "staTypeHelicopter")
    @Mapping(target = "airplaneRegistration", source = "staAirplaneRegistration")
    @Mapping(target = "hrsMaintenance", source = "staHrsMaintenance")
    @Mapping(target = "hrsAssigned", source = "staHrsAssigned")
    @Mapping(target = "hrsFlown", source = "staHrsFlown")
