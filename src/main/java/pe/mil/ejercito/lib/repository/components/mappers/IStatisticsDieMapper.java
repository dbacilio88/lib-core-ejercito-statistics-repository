...
public interface IStatisticsDieMapper {
    ...
    @Mapping(target = "stdActionOoTt", source = "actionOoTt")
    @Mapping(target = "stdActivities", source = "activities")
    @Mapping(target = "stdTypesMeasurements", source = "typesMeasurements")
    ...
    @Mapping(target = "actionOoTt", source = "stdActionOoTt")
    @Mapping(target = "activities", source = "stdActivities")
    @Mapping(target = "typesMeasurements", source = "stdTypesMeasurements")
