...
public interface IStatisticsDilogeMapper {
    ...
    @Mapping(target = "stdNew", source = "SNew")
    @Mapping(target = "stOtherState", source = "otherState")
    @Mapping(target = "stdUpdate", source = "SUpdate")
    @Mapping(target = "stdProgress", source = "SProgress")
    ...
    @Mapping(target = "SNew", source = "stdNew")
    @Mapping(target = "SUpdate", source = "stdUpdate")
    @Mapping(target = "SProgress", source = "stdProgress")
